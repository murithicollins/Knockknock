...
<div class="bg-white mx-auto  py-4 s-HCuzqHjNU96d shadow-xl sticky  top-0 w-full z-10">
  <Ruler>
    <nav>
            ...
            <li class="relative">
              ...
              <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <ul class="block text-right text-gray-900">
                      <li><a href="/main/bell" class="block px-4 py-2 text-[#EF6C00] font-primary font-bold hover:underline hover:bg-gray-200">I-bell</a></li>
                  </ul>
              </div>
            </li>
