...
<div class="flex justify center shadow-2xl bg-white p-10">
    ...
    <div class="">
        <img src="img/knock team.png" class="w-3/4 shadow-2xl bg-white rounded-3xl shadow-orange-500/50" alt="" />
    </div>
    <div class="w-10/12 my-20 shadow-2xl bg-white p-10 rounded-md">
        <h3 class="text-orange-500 font-bold">Our story:</h3>
        <p class="">
