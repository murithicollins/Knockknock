...
<div class="flex justify-center gap-10 shadow-2xl w-full bg-[#D9D9D9] p-10">
  <div class="">
    <img src="img/knock team.png" class="rounded-3xl " alt="" />
  </div>
  <div class="w-1/2 my-32">
    <h1 class="mb-4 text-xl font-bold leading-none tracking-tight text-[#EF6C00]">About Us</h1>
    <p class="">
...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800 text-center">
    <h2 class="text-3xl font-bold mb-32">Team</h2>
      ...
      <div class="flex gap-10 relative mb-24 md:mb-0">
        ...
        <div class="flex justify-center">
          <div class="rounded-lg shadow-lg absolute top-3/4 mt-20 inset-x-10 w-60 h-24 block bg-white">
            ...
            <div class="flex justify-center">
              <div class="">
                <h5 class="text-lg font-bold mt-2">Brian Olasya</h5>
                <p class="">Technical Lead</p>
              </div>
            </div>
            <div>
              <button class=" bg-[#EF6C00] text-white p-2 w-full rounded-md">Linked In</button>
      ...
      <div class="flex gap-10 relative mb-24 md:mb-0">
        ...
        <div class="flex justify-center">
          <div class="rounded-lg shadow-lg absolute top-3/4 mt-20 inset-x-10 w-60 h-24 block bg-white">
            ...
            <div class="flex justify-center">
              <div class="">
                <h5 class="text-lg font-bold mt-2">Joseph Mwanik</h5>
                <p class="">Operations Lead</p>
              </div>
            </div>
            <div>
              <button class=" bg-[#EF6C00] text-white p-2 w-full rounded-md">Linked In</button>
