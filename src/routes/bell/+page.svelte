    ...
    <div>
        ...
        <div class="flex flex-col md:flex-row  justify-center bg-[#D9D9D9]  gap-8 w-full p-4 md:p-10 my-4 md:my-10">
            ...
            <div class="w-full md:w-1/2 p-4 md:p-10 my-4 md:my-10">
                <h1 class="flex items-center justify-center font-primary text-xl font-bold text-[#EF6C00]">The problem</h1>
            ...
            <!-- about -->
            <div class="w-full md:w-1/2 p-4 md:p-10 my-4 md:my-10">
                <h1 class="flex justify-center font-primary text-2xl font-bold text-[#EF6C00]">About i-bell:</h1>
        ...
        <div class="flex justify-center bg-[#D9D9D9] w-full p-4 md:p-10 my-4 md:my-10">
            <div>
                ...
                <!-- context -->
                <div class="p-4 font-secondary text-24 text-[#00394F]">
                ...
                <div class="flex flex-col justify-center my-2 md:my-4 md:my-8 w-full md:w-5/6 p-4">
                    <p class="font-secondary font-bold  text-24 text-[#00394F]">
                        ✓ Implementation partners: 
                        <span class="p-4 font-secondary font-normal text-24 text-[#00394F]">  
